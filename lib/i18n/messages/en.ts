...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "terminal.placeholder": "Enter a Bash command…",
    "terminal.commandInput": "Bash command input",
    "terminal.running": "Command running — Ctrl+C to interrupt",
    "terminal.run": "Run",
    "terminal.stop": "Stop",
    "terminal.interrupt": "Interrupt command (Ctrl+C)",
    "terminal.clear": "Clear terminal (Ctrl+L)",
    ...
    "files.searchLabel": "Search project files",
    "files.clearSearch": "Clear file search",
    "files.searchResults": "File search results",
    "files.searching": "Searching…",
    "files.noSearchResults": "No matching files",
    "files.edit": "Edit",
    "files.revertGit": "Revert",
    "files.reverting": "Reverting…",
    "files.revertGitTitle": "Revert this file to HEAD",
    "files.revertGitConfirm": "Revert all staged and unstaged changes to this file to HEAD? This cannot be undone.",
    "files.revertAddedConfirm": "Revert this added file? The file will be deleted and removed from the Git index. This cannot be undone.",
    "files.discardEditConfirm": "Discard the unsaved changes to this file?",
    "files.closeDirtyConfirm": "Close this file and discard its unsaved changes?",
    "files.editConflict": "This file changed on disk. Cancel to reload it, then reapply your edit.",
