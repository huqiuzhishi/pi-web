...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "terminal.commandInput": "Bash 命令输入",
    "terminal.running": "命令运行中 — 按 Ctrl+C 中断",
    "terminal.run": "运行",
    "terminal.stop": "停止",
    "terminal.interrupt": "中断命令（Ctrl+C）",
    "terminal.clear": "清空终端（Ctrl+L）",
    ...
    "files.searchLabel": "搜索项目文件",
    "files.clearSearch": "清除文件搜索",
    "files.searchResults": "文件搜索结果",
    "files.searching": "搜索中…",
    "files.noSearchResults": "未找到匹配的文件",
    "files.edit": "编辑",
    "files.revertGit": "还原",
    "files.reverting": "正在还原…",
    "files.revertGitTitle": "将此文件还原到 HEAD",
    "files.revertGitConfirm": "要将此文件所有已暂存和未暂存的更改还原到 HEAD 吗？此操作无法撤销。",
    "files.revertAddedConfirm": "要还原这个新增文件吗？该文件将被删除并从 Git 索引中移除。此操作无法撤销。",
    "files.discardEditConfirm": "要放弃对此文件的未保存更改吗？",
    "files.closeDirtyConfirm": "要关闭此文件并放弃未保存的更改吗？",
    "files.editConflict": "此文件已在磁盘上更改。请取消编辑以重新加载，然后重新应用您的更改。",
